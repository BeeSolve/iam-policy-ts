...
export type GameliftAction = (typeof gameliftActions)[number];

export function gamelift(action: GameliftAction | "*"): `gamelift:${GameliftAction | "*"}` {
  return `gamelift:${action}` as `gamelift:${GameliftAction | "*"}`;
}
